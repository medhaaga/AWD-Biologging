...
sim_constants = [
    ...
    ("Feeding", "X", (1.8, 1.9, 2.0), (1.5, 1.8, 2.0), (0.2, 0.7, 1.2), 1.0),
    ("Feeding", "Y", (1.9, 1.8, 2.1), (1.6, 1.9, 2.0), (0.3, 0.8, 1.3), 1.0),
    ("Feeding", "Z", (2.0, 1.9, 1.8), (1.7, 1.8, 2.0), (0.4, 0.9, 1.4), 1.0),

    # Moving — slightly reduce amplitude, overlap more with Feeding
    ("Moving", "X", (1.9, 2.0, 2.2), (1.7, 1.9, 2.3), (0.6, 1.2, 1.8), 1.0),
    ("Moving", "Y", (1.9, 2.0, 2.1), (2.0, 2.0, 2.2), (0.5, 1.0, 1.5), 1.0),
    ("Moving", "Z", (2.0, 2.1, 2.2), (2.0, 2.1, 2.2), (0.7, 1.2, 1.8), 1.0),
    # Resting — make it slightly jittery to overlap with Vigilant
    ("Resting", "X", (0.2, 0.3, 0.4), (0.1, 0.15, 0.1), (0.0, 0.1, 0.2), 0.2),
    ...
    ("Vigilant", "X", (0.25, 0.35, 0.48), (0.15, 0.17, 0.15), (0.0, 0.3, 0.6), 0.2),
    ("Vigilant", "Y", (0.25, 0.35, 0.45), (0.14, 0.17, 0.15), (0.0, 0.4, 0.8), 0.2),
    ("Vigilant", "Z", (0.23, 0.32, 0.44), (0.16, 0.18, 0.1), (0.0, 0.5, 1.0), 0.2),
]
